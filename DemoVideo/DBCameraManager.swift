//
//  DBCameraManager.swift
//  DBCustomCamera
//
//  Created by Sotsys044 on 02/12/15.
//  Copyright © 2015 Sotsys044. All rights reserved.
//
...
class DBCameraManager: UIView , UIGestureRecognizerDelegate {
...
public enum CamerascreenType : String
{
    case AVLayerVideoGravityResizeAspectFill, AVLayerVideoGravityResizeAspect , AVLayerVideoGravityResize
}
...
public class CameraManager: NSObject, AVCaptureFileOutputRecordingDelegate {
    ...
    private var currentDevice: AVCaptureDevice?
      ...
      public var device: AVCaptureDevice?
        ...
        public var sessionQueue1: dispatch_queue_t?
    
    /// Capture session to customize camera settings.
    public var captureSession: AVCaptureSession?
    
    public var SubClassView: UIView?
            ...
            if cameraOutputMode == .StillImage {
                dispatch_async(sessionQueue, {
                    self._getStillImageOutput().captureStillImageAsynchronouslyFromConnection(self._getStillImageOutput().connectionWithMediaType(AVMediaTypeVideo), completionHandler: { [weak self] (sample: CMSampleBuffer!, error: NSError!) -> Void in
                        ...
                        //    self?.SquareImage_Crop(imageData)
...
//    func SquareImage_Crop(Data:NSData)
//    {
...
//    }
    ...
    private func _canLoadCamera() -> Bool {
        ...
        return currentCameraState == .Ready || (currentCameraState == .NotDetermined && showAccessPermissionPopupAutomatically == true)
    }
...
//            if String(CamerascreenType.AVLayerVideoGravityResize) == AVLayerVideoGravityResize
//            {
                previewLayer?.videoGravity = AVLayerVideoGravityResize
//            }
//            else if String(CamerascreenType.AVLayerVideoGravityResizeAspect) == AVLayerVideoGravityResizeAspect
//            {
//                previewLayer?.videoGravity = AVLayerVideoGravityResizeAspect
//            }
//            else if String(CamerascreenType.AVLayerVideoGravityResizeAspectFill) == AVLayerVideoGravityResizeAspectFill
//            {
...
//            }
    ...
    func tapon(touchPoint: CGPoint ,setview : UIView)
    {
        ...
        func showFocusViewAtPoint(touchPoint: CGPoint) {
            ...
            setview.addSubview(FocusView.focusView)
            UIView.animateWithDuration(0.7, delay: 0, usingSpringWithDamping: 0.5, initialSpringVelocity: 1.1,
                options: .CurveEaseInOut, animations: { () -> Void in
                    FocusView.focusView.transform = CGAffineTransformScale(CGAffineTransformIdentity, 0.4, 0.4)
                }) { (Bool) -> Void in
